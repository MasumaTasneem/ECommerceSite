...
session_start();
    ...
    $query = "SELECT CONCAT_WS(' ', FirstName, LastName) AS name,EmailAddress, PhoneNumber, UserAddress, product.ProductID,ProductName, category.CategoryID, CategoryName,purchase.PurchaseID, sum(purchase.UnitPrice) as TotalPrice ,sum(purchase.PurchaseQuantity) as TotalQuantity,PaymentMethod,Date_Time FROM userinfo, buyerinfo, product, category,advertisement, purchase,payment where purchase.confirm=0 and userinfo.UserID=buyerinfo.UserID and product.ProductID=advertisement.ProductID and category.CategoryID=product.CategoryID and purchase.ProductID=product.ProductID and payment.PaymentID=purchase.PaymentID and buyerinfo.UserID=purchase.UserID GROUP BY advertisement.ProductID";
...
<body style="background-color:white" >
			...
			<h3 style="color:white; font-family:Comic Sans MS; font-size:20px">ADMIN PANEL</h3>
			  ...
			  <li><a href="ConfirmPurchase.php">Confirmed Purchase List</a></li>
	...
	<div class="list">
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
					...
					<td><a href="ConfirmPurchase.php?PurchaseID=<?php echo $row['PurchaseID']?>" >Confirm</a></td>

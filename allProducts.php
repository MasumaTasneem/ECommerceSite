...
$UserID=$_SESSION['UserID'];
    ...
    $query = "SELECT product.ProductID,ProductName,CategoryName,Specification,Options,UnitPrice,Rating FROM product,category,advertisement WHERE advertisement.showAdd=1 and product.ProductID=advertisement.ProductID AND category.CategoryID=Product.CategoryID";
